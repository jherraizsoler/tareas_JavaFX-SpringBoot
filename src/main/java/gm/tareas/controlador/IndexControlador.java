...
public class IndexControlador implements Initializable {
    ...
    public void agregarTarea(){
        if(nombreTareaTexto.getText().isBlank()){
            mostrarMensaje("Error Validación", "Debe proporcionar una tarea");
            nombreTareaTexto.requestFocus();
            return;
        } else if (responsableTexto.getText().isBlank()) {
            mostrarMensaje("Error Validación", "Debe proporcionar un responsable");
            responsableTexto.requestFocus();
            return;
        } else if (estatusTexto.getText().isBlank()) {
            mostrarMensaje("Error Validación", "Debe proporcionar un estatus");
    ...
    public void  modificarTarea(){
        ...
        if (responsableTexto.getText().isBlank()) {
            mostrarMensaje("Error Validación", "Debe proporcionar un responsable");
            responsableTexto.requestFocus();
            return;
        }
        if (estatusTexto.getText().isBlank()) {
            mostrarMensaje("Error Validación", "Debe proporcionar un estatus");
            estatusTexto.requestFocus();
            return;
        }
    ...
    //Manera de mostrar alertas en JavaFx
